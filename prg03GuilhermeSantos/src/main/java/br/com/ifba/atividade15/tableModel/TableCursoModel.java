 ...
 */
package br.com.ifba.atividade15.tableModel;
...
public class TableCursoModel extends AbstractTableModel {
  ...
  private List<CursoA15> dados;

  public TableCursoModel(List<CursoA15> dadosIniciais) {
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    CursoA15 curso = dados.get(rowIndex); // Pega o objeto CursoA15 da linha atual
  ...
  public void addCurso(CursoA15 curso) {
  ...
  public CursoA15 getCursoAt(int rowIndex) {
    if (rowIndex >= 0 && rowIndex < dados.size()) {
  ...
  public void setDados(List<CursoA15> novosDados) {
