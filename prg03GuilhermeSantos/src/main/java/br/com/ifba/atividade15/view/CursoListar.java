 ...
 */
package br.com.ifba.atividade15.view;

import br.com.ifba.atividade15.util.ButtonRenderer;
import br.com.ifba.atividade15.curso.dao.CursoDao;
import br.com.ifba.atividade15.util.ButtonEditor;
import br.com.ifba.atividade15.tableModel.TableCursoModel;
...
public class CursoListar extends javax.swing.JFrame {
  ...
  public void removerCursoDaTabela(int rowIndex) {
    CursoA15 cursoParaRemover = tableModel.getCursoAt(rowIndex);
  ...
  public void editarCursoDaTabela(int rowIndex) {
    CursoA15 cursoParaEditar = tableModel.getCursoAt(rowIndex);
  ...
  private void realizaBusca(String termoBusca) {
    List<CursoA15> resultados = new ArrayList<>();
    ...
    if (termoLowerCase.isEmpty()) {
      ...
      for (CursoA15 curso : manager.findAll()) {
