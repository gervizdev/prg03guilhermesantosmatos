 ...
 */
package br.com.ifba.atividade16.curso.entity;
...
@Entity
@Table(name = "cursos")
public class CursoA16 extends PersistenceEntity {
  ...
  public CursoA16(long id, String nome, String codigoCurso, boolean ativo) {
    this.nome = nome;
