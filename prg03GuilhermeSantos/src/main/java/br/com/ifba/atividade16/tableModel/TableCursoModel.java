 ...
 */
package br.com.ifba.atividade16.tableModel;
...
public class TableCursoModel extends AbstractTableModel {
  ...
  private List<CursoA16> dados;

  public TableCursoModel(List<CursoA16> dadosIniciais) {
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    CursoA16 curso = dados.get(rowIndex); // Pega o objeto CursoA16 da linha atual
  ...
  public void addCurso(CursoA16 curso) {
  ...
  public CursoA16 getCursoAt(int rowIndex) {
    if (rowIndex >= 0 && rowIndex < dados.size()) {
  ...
  public void setDados(List<CursoA16> novosDados) {
