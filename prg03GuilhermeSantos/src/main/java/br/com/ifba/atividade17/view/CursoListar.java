...
import br.com.ifba.atividade17.util.ButtonRenderer;
import br.com.ifba.atividade17.util.ButtonEditor;
...
public class CursoListar extends javax.swing.JFrame {
  ...
  public void atualizarTabela() {
    List<CursoA17> cursos = manager.findAll();
    tableModel.setDados(cursos);
  }

  private void abrirAddOrEditCurso(boolean edit, CursoA17 curso) {
  ...
  public void removerCursoDaTabela(int rowIndex) {
    CursoA17 cursoParaRemover = tableModel.getCursoAt(rowIndex);
  ...
  public void editarCursoDaTabela(int rowIndex) {
    CursoA17 cursoParaEditar = tableModel.getCursoAt(rowIndex);
