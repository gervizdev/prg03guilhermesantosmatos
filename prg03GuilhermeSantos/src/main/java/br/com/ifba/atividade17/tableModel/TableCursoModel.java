 ...
 */
package br.com.ifba.atividade17.tableModel;
...
public class TableCursoModel extends AbstractTableModel {
  ...
  private List<CursoA17> dados;

  public TableCursoModel(List<CursoA17> dadosIniciais) {
  ...
  public Object getValueAt(int rowIndex, int columnIndex) {
    CursoA17 curso = dados.get(rowIndex); // Pega o objeto CursoA17 da linha atual
  ...
  public void addCurso(CursoA17 curso) {
  ...
  public CursoA17 getCursoAt(int rowIndex) {
    if (rowIndex >= 0 && rowIndex < dados.size()) {
  ...
  public void setDados(List<CursoA17> novosDados) {
