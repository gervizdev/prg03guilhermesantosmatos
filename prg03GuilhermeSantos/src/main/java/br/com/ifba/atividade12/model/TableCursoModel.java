...
public class TableCursoModel extends AbstractTableModel{
  ...
  // Nomes das colunas que vão aparecer na sua tabela
    private final String[] colunas = {"NOME", "QUANTIDADE", "DESCRIÇÃO", "FORNECEDOR", "REMOVER", "EDITAR"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 1: return curso.getQuantidade();
            case 2: return curso.getDescricao();
            case 3: return curso.getFornecedor();
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0: curso.setNome((String) aValue); break;
            case 1: curso.setQuantidade((int) aValue); break;
            case 2: curso.setDescricao((String) aValue); break;
            case 3: curso.setFornecedor((String) aValue); break;
